...
public class ServicesItem implements IServicesItem{
	...
	public List<Items> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://localhost:80/api/productos", Producto[].class));
	...
	public Items findById(Long id, Integer cantidad) {
		...
		Producto producto = clienteRest.getForObject("http://localhost:80/api/productos/{id}", Producto.class, pathVariables);
